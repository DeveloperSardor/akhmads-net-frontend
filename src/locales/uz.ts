export const uz = {
  ...
  myAds: {
    ...
    broadcasts: {
      noBroadcasts: "Broadcast topilmadi",
      noBroadcastsDesc: "Hali birorta broadcast kampaniyasi yaratilmagan",
      createBtn: "Broadcast yaratish",
      newBtn: "Yangi Broadcast",
      target: "Maqsad",
      sent: "Yuborildi",
      failed: "Xatolik",
      cost: "Xarajat",
  ...
  broadcastAd: {
    ...
    checkout: {
      ...
      launch: "YUBORISH",
      info: "Broadcast bir necha daqiqa ichida yetkaziladi. Xabarlar botingiz orqali to'g'ridan-to'g'ri yuboriladi.",
      botStats: "statistikasi",
    },
    successMessage: "Broadcast yaratildi! Moderatsiya kutilmoqda.",
    errorLoadingBots: "Botlarni yuklashda xatolik",
    errorCreating: "Broadcast yaratishda xatolik",
    buttonColors: {
      blue: "Ko'k",
      green: "Yashil",
      red: "Qizil",
