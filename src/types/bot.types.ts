...
export interface Bot {
  ...
  pdpEnabled?: boolean;
  pokazEnabled?: boolean;
  autoAcceptAds?: boolean;
  pricePerClick?: number;
  pricePerPokaz?: number;
  createdAt: string;
  updatedAt: string;
}
...
export const BOT_CATEGORIES: BotCategory[] = [
  ...
  {
    id: "chat",
    nameUz: "Chat va tanishuvlar",
    nameRu: "Чаты и знакомства",
    nameEn: "Chats & Dating",
    icon: "💬",
  },
  {
  ...
  {
    id: "currency",
    nameUz: "Valyuta kurslari",
    nameRu: "Курсы валют",
    nameEn: "Currency Rates",
    icon: "💱",
  },
  {
    id: "games",
  ...
  {
    id: "fitness",
    nameUz: "Fitnes / Salomatlik",
    nameRu: "Фитнес / Здоровье",
  ...
  },
  {
    id: "group",
    nameUz: "Guruh-botlar",
    nameRu: "Групповые / Чат-боты",
    nameEn: "Group / Chat Bots",
    icon: "👥",
  },
  {
    id: "books",
  ...
  {
    id: "converter",
    nameUz: "Fayl konverterlari",
    nameRu: "Конвертеры файлов",
    nameEn: "File Converters",
    icon: "🔄",
  },
  {
    id: "horoscope",
