            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-white/10 bg-white/[0.02]">
                  ...
                  <th className="px-6 py-4 text-left text-xs font-semibold uppercase tracking-wider text-white/60">{b?.tableHeaders.members}</th>
                  ...
                  <tr key={bot.id} className="transition hover:bg-white/[0.03] group">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <p className="font-semibold text-white">{formatNumber(bot.totalMembers || 0)}</p>
                          <p className="text-xs text-white/50">
                            {formatNumber(bot.activeMembers || 0)} {b?.active}
                          </p>
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-end gap-1.5">
                        ...
                        <button
                          onClick={() => navigate(`/${lang}/bots/${bot.id}`)}
          ...
          <div className="border-t border-white/10 bg-white/[0.01] px-6 py-4">
            <div className="flex items-center justify-between text-sm">
              <div className="flex items-center gap-6 text-white/60">
                ...
                <span className="w-px h-4 bg-white/10"></span>
                <span>
                  {b?.totalMembers}: <strong className="text-purple-400">
                    {formatNumber(botsList.reduce((sum, bot) => sum + (bot.totalMembers || 0), 0))}
                  </strong>
                </span>
              </div>
            </div>
