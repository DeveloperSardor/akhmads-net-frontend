            ...
            <div className="flex items-center gap-2">
              {steps.map((step, index) => (
                <div key={index} className="flex items-center">
                  <div
                    className={`flex items-center gap-2.5 px-4 py-2.5 rounded-xl border transition-all ${currentStep === index
                  ...
                  >
                    {currentStep > index ? (
                      ...
                      <div
                        className={`w-5 h-5 rounded-full flex items-center justify-center text-xs font-bold ${currentStep === index
                  ...
                  {index < steps.length - 1 && (
                    <div
                      className={`hidden lg:block w-8 h-px mx-1 ${currentStep > index ? "bg-green-500" : "bg-border"
                        }`}
                    />
                  )}
                </div>
